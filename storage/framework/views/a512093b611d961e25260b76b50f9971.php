...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/Proyectos-admin.css']); ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/js/Proyectos-admin.js']); ?>
    <?php else: ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/Proyectos.css']); ?>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/js/proyectos.js']); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <div class="w-full bg-[#315F68] text-white px-6 py-3 shadow-md sticky top-0 mt-[-30px] admin-bar">
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                <h2 class="text-lg font-semibold"><?php echo e($page->title ?? "no funciona"); ?></h2>
                <div class="flex gap-4">
                    <a href="#" id="btnGuardar" class="hover:text-[#0cccf2]" data-page-id="<?php echo e($page->id); ?>">
                        Guardar
                    </a>
    ...
    <div class="w-full h-fit  flex justify-center items-center flex-col">
        <div class="text-white w-[60%] h-[50%]  flex  justify-start p-4  flex-col">
            ...
            <div id="Container-pagina" class="grid gap-4 p-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $page->structure; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('partials.render-block', ['block' => $block], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\javier\Desktop\Trabajo\Porta_folio-12.4\resources\views/Proyectos.blade.php ENDPATH**/ ?>