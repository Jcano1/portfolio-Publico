<x-app-layout>
    ...
    @vite(['resources/js/Portfolio_Habilidades.js'])
    @vite(['resources/css/portfolio.css'])
    @vite(['resources/js/Portfolio_Projectos.js'])
    @vite(['resources/js/contacto_Correo.js'])
    @auth
        @vite(['resources/js/Portfolio_Habilidades_Admin.js'])
        @vite(['resources/js/Portfolio_Projectos-admin.js'])
        @vite(['resources/js/portfolio_editData.js'])
        @vite(['resources/css/portfolio-admin.css'])
    @endauth
    ...
    : 'No hay admin'
        ...
        <div class="text-white w-[60%] h-[50%]  flex  justify-start p-4  flex-col relative">
            ...
            <div class="text-[16px] overflow-auto" style="white-space: pre-wrap; margin: 0;" id="Description">{!!$admin?->description ?? 'No hay admin'!!}</div>
        </div>
        ...
        <div class="text-white w-[60%] h-[50%]  flex  justify-center p-4  flex-col" id="ContainerFormContacto">
            ...
            <div class="container-Contacto py-[50px]">
                {{-- **Cambio 1: Aplicar clase .form-container al formulario** --}}
                <form id="contactForm" method="POST" action="{{ route('contact.send') }}" class="form-container">
                    @csrf

                    {{-- **Cambio 2: Usar las clases definidas en tu CSS** --}}
                    <div>
